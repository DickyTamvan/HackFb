...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mWELCOME \033[1;92m" +nama+ "\n\033[1;97mTerimakasih telah menggunakan tools ini Silahkan Login FB Di OPERA MINI Dahulu Agak Tidak Kena CP !!")
		time.sleep(1)
		loginSC()
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/DICKY Channel')
				menu()
